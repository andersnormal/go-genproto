...
PKG=github.com/andersnormal/genproto
PROTO_REPO=https://github.com/google/protobuf
PROTO_SUBDIR=src/google/protobuf
API_REPO=https://github.com/andersnormal/apis
...
if [ -z "$APIS" ]; then
  ...
  git clone --recurse-submodules -q $API_REPO $apidir
  ln -s "${apidir}/googleapis/google" "${apidir}/google"
